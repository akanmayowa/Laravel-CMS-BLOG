...
@endif
        ...
        @endif
            ...
            <div class="mb-8">
            <div class="text-gray-900 mt-10 font-bold text-xl mb-2">Create Post form </div>
            ...
            <div class="px-4 py-5 bg-white sm:p-6">
              <div class="grid grid-cols-6 gap-6">
                <div class="col-span-6 sm:col-span-3">
                  ...
                  <input type="text" name="title" class="mt-1  block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                </div>
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <input type="file" name="featured" class="mt-1  block w-full border-gray-300 rounded-md" />
                  </div>
