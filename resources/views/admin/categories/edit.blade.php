...
@endif
        ...
        <div class="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
            ...
            <div class="mb-8">
            <div class="text-gray-900 mt-10 font-bold text-xl mb-2">Update Category {{$category->name}}  </div>
                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                  <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-3">
                      ...
                      <input type="text" value="{{$category->name}}" name="name" class="mt-1  block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                    </div>
